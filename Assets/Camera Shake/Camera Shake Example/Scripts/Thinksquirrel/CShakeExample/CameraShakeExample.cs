...
namespace Thinksquirrel.CShakeExample
{
    ...
    public class CameraShakeExample : MonoBehaviour
    {
        ...
        private Thinksquirrel.CShake.CameraShake m_Shake;
        ...
        private void Start()
        {
            ...
            m_Shake = GetComponent<Thinksquirrel.CShake.CameraShake>();
        ...
        private void Update()
        {
            ...
            if (m_Shake.shakeType == Thinksquirrel.CShake.CameraShake.ShakeType.CameraMatrix)
            {
