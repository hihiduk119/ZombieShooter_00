...
public class projectileActorExplosion1 : MonoBehaviour {
    ...
    public UnityAction explosionAction;

    void ExplosionInvoke() 
    {
        Debug.Log("Boom");
    ...
    void Start ()
    {
        ...
        //add code
        explosionAction = new UnityAction(ExplosionInvoke);
        //end
    }
    ...
    public void Fire()
    {
        ...
        ExplodingProjectileExplosion1 epe = rocketInstance.transform.GetComponent<ExplodingProjectileExplosion1>();
        epe.explosionEvent.AddListener(explosionAction);
