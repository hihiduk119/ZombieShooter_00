...
public class OutlineCustomPass : CustomPass
{
    ...
    protected override void Execute(ScriptableRenderContext renderContext, CommandBuffer cmd, HDCamera hdCamera, CullingResults cullingResult)
    {
        ...
        foreach (var outliner in outliners)
            UpdateOutliner(renderContext, camera, outliner);
    ...
    private void UpdateOutliner(ScriptableRenderContext renderContext, Camera camera, Outliner outlineEffect)
    {
        ...
        parameters.OutlineLayerMask = outlineEffect.OutlineLayerMask;
        ...
        if (outlineEffect.RenderingStrategy == OutlineRenderingStrategy.Default)
        {
            ...
            parameters.TargetWidth = colorTarget.referenceSize.x;
            parameters.TargetHeight = colorTarget.referenceSize.y;
