    ...
    public class UIDemo : MonoBehaviour
    {
        ...
        void Start( )
        {
            ...
            if( isSceneTextMeshPro )
            {
                ...
                labelText.text = "ALERT: This demo won't work using the new 'TextMeshPro' with the current configuration.\nYou can change the configuration of UltimateTextDamage and switching to TextMeshPro by going to the menu 'UltimateTextDamage->Open preferences'";
            }
            else
            {
                labelText.enabled = textMeshProOK;
                labelText.text = "ALERT: This demo won't work using the old 'Text' with the current configuration.\nYou can change the configuration of UltimateTextDamage and switching to not use TextMeshPro by going to the menu 'UltimateTextDamage->Open preferences'";
            }
#endif
        }
    }
