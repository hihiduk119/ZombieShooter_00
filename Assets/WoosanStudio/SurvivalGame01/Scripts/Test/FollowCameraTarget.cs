...
namespace Woosan.SurvivalGame01
{
    ...
    public class FollowCameraTarget : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            //러프를 걸 타겟
            joystickTarget.transform.localPosition = pos;
            ...
            if (Mathf.Abs(distanceLockCenterTarget.transform.position.z - player.transform.position.z)  > 3) {
                ...
                //followTarget 부분
                followTarget.transform.localPosition = Vector3.Lerp(followTarget.transform.localPosition, player.transform.localPosition, Time.deltaTime * recoverStrong);
            }
