...
namespace WoosanStudio.ZombieShooter
{
    ...
    /// *MVP 모델
    /// </summary>
    public class UINotifyPurchaseEnergyPopupLinker : MonoBehaviour
    {
        [Header("[모델 역활]")]
        ...
        public UINotifyPurchaseEnergyPopupPresenter FromPresenter;
        ...
        {
            //openPopup에서 가져옴
            FromPresenter = openPopup.popupPrefab.GetComponent<UINotifyPurchaseEnergyPopupPresenter>();
            Debug.Log("전달 완료");
