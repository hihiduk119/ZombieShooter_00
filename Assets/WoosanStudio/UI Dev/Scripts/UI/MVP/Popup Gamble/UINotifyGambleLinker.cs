...
namespace WoosanStudio.ZombieShooter
{
    ...
    /// 도박 최종 알림 링커
    /// </summary>
    public class UINotifyGambleLinker : MonoBehaviour
    {
        [Header("[모델 역활 프리젠트]")]
        ...
        public UINotifyGamblePresenter FromPresenter;
        ...
        {
            //openPopup에서 가져옴
            FromPresenter = openPopup.popupPrefab.GetComponent<UINotifyGamblePresenter>();
            Debug.Log("도박 링커 => 전달 완료");
